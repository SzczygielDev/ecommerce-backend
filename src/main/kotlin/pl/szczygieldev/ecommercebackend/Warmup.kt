...
@Component
class Warmup(val cartUseCase: CartUseCase, val productUseCase: ProductUseCase, val imageRepository: ImageRepository) {
    ...
    suspend fun initData() {
        ...
        initializeImage("static/images/products/1.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt A", "Opis produktu", 300.0,it ))
        }
        initializeImage("static/images/products/2.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt B", "Opis produktu", 1000.0,it ))
        }
        initializeImage("static/images/products/3.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt C", "Opis produktu", 50.0,it ))
        }
        initializeImage("static/images/products/4.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt D", "Opis produktu", 100.0,it ))
        }
        initializeImage("static/images/products/5.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt E", "Opis produktu", 500.0,it ))
        }
        initializeImage("static/images/products/6.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt F", "Opis produktu", 30.0,it ))
        }
        initializeImage("static/images/products/7.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt G", "Opis produktu", 700.0,it ))
        }
        initializeImage("static/images/products/8.jpg")?.let {
            productUseCase.create(CreateProductCommand("Produkt H", "Opis produktu", 30.0,it ))
        }
    }
}