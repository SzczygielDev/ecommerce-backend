...
class RejectOrderCommandHandler(val orders: Orders, val orderEventPublisher: DomainEventPublisher<OrderEvent>) :
    CommandHandler<RejectOrderCommand, Either<AppError, Unit>> {

    override fun execute(command: RejectOrderCommand): Either<AppError, Unit> = either {
