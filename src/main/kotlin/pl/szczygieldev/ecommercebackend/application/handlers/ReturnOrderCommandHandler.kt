...
class ReturnOrderCommandHandler(val orders: Orders, val orderEventPublisher: DomainEventPublisher<OrderEvent>) :
    CommandHandler<ReturnOrderCommand, Either<AppError, Unit>> {

    override fun execute(command: ReturnOrderCommand): Either<AppError, Unit> = either {
