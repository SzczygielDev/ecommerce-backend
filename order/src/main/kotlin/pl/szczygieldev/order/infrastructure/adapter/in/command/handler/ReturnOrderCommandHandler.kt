...
) : CommandWithResultHandler<ReturnOrderCommand, Either<CommandError, Unit>> {

    override suspend fun handle(command: ReturnOrderCommand): Either<CommandError, Unit> = either {
