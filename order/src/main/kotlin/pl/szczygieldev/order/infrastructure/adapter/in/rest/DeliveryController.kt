...
import pl.szczygieldev.order.infrastructure.adapter.`in`.rest.resource.ParcelStatus
import pl.szczygieldev.order.infrastructure.adapter.`in`.rest.resource.ParcelStatusChangeNotificationRequest
import pl.szczygieldev.order.infrastructure.mapper.DeliveryProviderMapper

@RequestMapping("/delivery")
@RestController
class DeliveryController(val deliveryProviderMapper: DeliveryProviderMapper,val mediatorFacade: MediatorFacade) {
