...
) : CommandWithResultHandler<CreateCartCommand, Either<CommandError, Unit>> {
    override suspend fun handle(command: CreateCartCommand): Either<CommandError, Unit> = either {
