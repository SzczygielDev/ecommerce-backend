...
import pl.szczygieldev.ecommercelibrary.outbox.spring.StoreAndForwardApplicationEventPublisher
...
internal class ProductEventPublisher(eventPublisher: ApplicationEventPublisher, outbox: Outbox) :
    StoreAndForwardApplicationEventPublisher<ProductEvent>(eventPublisher, outbox, ProductEventMapper())