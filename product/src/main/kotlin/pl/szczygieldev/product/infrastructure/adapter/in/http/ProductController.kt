...
import pl.szczygieldev.product.infrastructure.adapter.`in`.http.presenter.ProductPresenter
import pl.szczygieldev.product.infrastructure.adapter.`in`.http.resource.CreateProductRequest
import pl.szczygieldev.product.infrastructure.adapter.`in`.http.resource.ProductDto
import pl.szczygieldev.product.infrastructure.adapter.`in`.http.resource.UpdateProductRequest
import java.util.*
